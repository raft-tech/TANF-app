...
- [React Admin Console: High-Level Architecture Specification](#react-admin-console-high-level-architecture-specification)
  ...
  - [Decision Snapshot (ADR Summary)](#decision-snapshot-adr-summary)
    - [Decision](#decision)
    - [Options Considered](#options-considered)
    - [Why this decision](#why-this-decision)
    - [Important tradeoff](#important-tradeoff)
  - [Problem Statement](#problem-statement)
  - [Architecture Scope and Principles](#architecture-scope-and-principles)
  ...
  - [Migration Strategy (8-Week MVP)](#migration-strategy-8-week-mvp)
    - [MVP objective](#mvp-objective)
    - [Recommended MVP scope](#recommended-mvp-scope)
    - [Defer to post-MVP](#defer-to-post-mvp)
    - [Phase outline](#phase-outline)
  - [Risks and Mitigations](#risks-and-mitigations)
  - [Open Questions and Required Decisions](#open-questions-and-required-decisions)
