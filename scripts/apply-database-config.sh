...
python manage.py runscript create_grafana_postgres_role --script-args digit_sensitive data_files_datafile django_admin_log etl_etlartifact etl_etlnoderun etl_etlpipelinerun etl_etlqaresult etl_statisticalweight etl_statisticalweightscasecount parsers_datafilesummary parser_error stts_stt stts_region users_user users_user_groups mr_record_counts_by_tableview stt_section_to_type_mapping user_views admin_views
