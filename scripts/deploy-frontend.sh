...
update_frontend()
{
    ...
    if [ "$CF_SPACE" = "tanf-prod" ]; then
        ...
        echo "REACT_APP_BACKEND_URL=https://$CGHOSTNAME_BACKEND.acf.hhs.gov/v1" >> .env.development
        echo "REACT_APP_BACKEND_HOST=https://$CGHOSTNAME_BACKEND.acf.hhs.gov" >> .env.development
