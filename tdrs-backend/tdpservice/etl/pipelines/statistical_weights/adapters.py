...
PROGRAM_ADAPTERS = {
    ProgramCode.TANF: ProgramAdapter(
    ...
    ProgramCode.SSP: ProgramAdapter(
    ...
    ProgramCode.TRIBAL: ProgramAdapter(
...
def adapter_for_program(program_type: str) -> ProgramAdapter:
    """Return the configured adapter for an exact canonical Program code."""
    try:
