...
def email_admin_num_access_requests():
    ...
    text_message = f'This is an automated email. Please do not reply.' + \
                    f'This email is to notify you of the number of users who have requested access to the TANF Data Portal.' + \
                    f'There are currently {num_access_requests} pending access requests'
