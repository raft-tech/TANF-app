...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "Tribal Closed Case Data Successfully Submitted Without Errors",
            "Tribal TANF",
            "TRIBAL",
            False,
        ),
        (
            "Closed Case Data",
            DataFileSummary.Status.ACCEPTED,
            "Tribal Closed Case Data Submission Errors Resolved",
            "Tribal TANF",
            "TRIBAL",
            True,
        ),
        (
            "Active Case Data",
            DataFileSummary.Status.ACCEPTED,
            "Tribal Active Case Data Successfully Submitted Without Errors",
            "Tribal TANF",
            "TRIBAL",
            False,
        ),
        (
            "Active Case Data",
            DataFileSummary.Status.ACCEPTED,
            "Tribal Active Case Data Submission Errors Resolved",
            "Tribal TANF",
            "TRIBAL",
            True,
        ),
        (
            ...
            "Action Required: Tribal Aggregate Data Contains Errors",
            "Tribal TANF",
            "TRIBAL",
            False,
        ),
        (
            "Aggregate Data",
            DataFileSummary.Status.ACCEPTED_WITH_ERRORS,
            "Action Required: Error Report Available for Tribal Aggregate Data Submission",
            "Tribal TANF",
            "TRIBAL",
            True,
        ),
        (
            ...
            "Action Required: Tribal Stratum Data Contains Errors",
            "Tribal TANF",
            "TRIBAL",
            False,
        ),
        (
            "Stratum Data",
            DataFileSummary.Status.PARTIALLY_ACCEPTED,
            "Action Required: Error Report Available for Tribal Stratum Data Submission",
            "Tribal TANF",
            "TRIBAL",
            True,
        ),
        ...
        (
            "Aggregate Data",
            DataFileSummary.Status.ACCEPTED,
            "SSP Aggregate Data Successfully Submitted Without Errors",
            "SSP",
            "SSP",
            False,
        ),
        (
            "Aggregate Data",
            DataFileSummary.Status.ACCEPTED,
            "SSP Aggregate Data Submission Errors Resolved",
            "SSP",
            "SSP",
            True,
        ),
        (
            "Closed Case Data",
            DataFileSummary.Status.ACCEPTED,
            "SSP Closed Case Data Successfully Submitted Without Errors",
            "SSP",
            "SSP",
            False,
        ),
        (
            "Closed Case Data",
            DataFileSummary.Status.ACCEPTED,
            "SSP Closed Case Data Submission Errors Resolved",
            "SSP",
            "SSP",
            True,
        ),
        (
            "Active Case Data",
            DataFileSummary.Status.ACCEPTED_WITH_ERRORS,
            "Action Required: SSP Active Case Data Contains Errors",
            "SSP",
            "SSP",
            False,
        ),
        (
            "Active Case Data",
            DataFileSummary.Status.ACCEPTED_WITH_ERRORS,
            "Action Required: Error Report Available for SSP Active Case Data Submission",
            "SSP",
            "SSP",
            True,
        ),
        (
            "Stratum Data",
            DataFileSummary.Status.PARTIALLY_ACCEPTED,
            "Action Required: SSP Stratum Data Contains Errors",
            "SSP",
            "SSP",
            False,
        ),
        (
            "Stratum Data",
            DataFileSummary.Status.PARTIALLY_ACCEPTED,
            "Action Required: Error Report Available for SSP Stratum Data Submission",
            "SSP",
            "SSP",
            True,
        ),
        ...
        (
            "Active Case Data",
            DataFileSummary.Status.ACCEPTED,
            "Active Case Data Successfully Submitted Without Errors",
            "TANF",
            "TAN",
            False,
        ),
        (
            "Active Case Data",
            DataFileSummary.Status.ACCEPTED,
            "Active Case Data Submission Errors Resolved",
            "TANF",
            "TAN",
            True,
        ),
        (
            "Closed Case Data",
            DataFileSummary.Status.ACCEPTED,
            "Closed Case Data Successfully Submitted Without Errors",
            "TANF",
            "TAN",
            False,
        ),
        (
            "Closed Case Data",
            DataFileSummary.Status.ACCEPTED,
            "Closed Case Data Submission Errors Resolved",
            "TANF",
            "TAN",
            True,
        ),
        (
            "Aggregate Data",
            DataFileSummary.Status.ACCEPTED_WITH_ERRORS,
            "Action Required: Aggregate Data Contains Errors",
            "TANF",
            "TAN",
            False,
        ),
        (
            "Aggregate Data",
            DataFileSummary.Status.ACCEPTED_WITH_ERRORS,
            "Action Required: Error Report Available for Aggregate Data Submission",
            "TANF",
            "TAN",
            True,
        ),
        (
            "Stratum Data",
            DataFileSummary.Status.PARTIALLY_ACCEPTED,
            "Action Required: Stratum Data Contains Errors",
            "TANF",
            "TAN",
            False,
        ),
        (
            "Stratum Data",
            DataFileSummary.Status.PARTIALLY_ACCEPTED,
            "Action Required: Error Report Available for Stratum Data Submission",
            "TANF",
            "TAN",
            True,
        ),
        ...
        (
            ...
            DataFileSummary.Status.ACCEPTED,
            "Work Outcomes of TANF Exiters Successfully Submitted Without Errors",
            "FRA",
            "FRA",
            False,
        ),
        (
            "Work Outcomes of TANF Exiters",
            DataFileSummary.Status.ACCEPTED,
            "Work Outcomes of TANF Exiters Submission Errors Resolved",
            "FRA",
            "FRA",
            True,
        ),
        (
            "Work Outcomes of TANF Exiters",
            DataFileSummary.Status.REJECTED,
            "Action Required: Work Outcomes of TANF Exiters Contains Errors",
            "FRA",
            "FRA",
            False,
        ),
        (
            "Work Outcomes of TANF Exiters",
            DataFileSummary.Status.REJECTED,
            "Action Required: Error Report Available for Work Outcomes of TANF Exiters Submission",
            "FRA",
            "FRA",
            True,
        ),
...
def test_send_stuck_file_email(user, stt):
    ...
    df2 = DataFile(
        user=user,
        section=Section.objects.get(program__code="TAN", name="Closed Case Data"),
        quarter="Q1",
        year=2025,
        stt=stt,
    )
