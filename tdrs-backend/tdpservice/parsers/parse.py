...
def parse_datafile(datafile, dfs):
    ...
    tribe_is_valid, tribe_error, id = category1.validate_tribe_fips_program_agree(
        header['program_type'],
    ...
    section_is_valid, section_error, id = category1.validate_header_section_matches_submission(
        datafile,
    ...
    rpt_month_year_is_valid, rpt_month_year_error, id = category1.validate_header_rpt_month_year(
        datafile,
        header,
        util.make_generate_parser_error(datafile, 1)
    )
