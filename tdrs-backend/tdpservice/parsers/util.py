...
def generate_parser_error(datafile, line_number, schema, error_category, error_message,
                          record=None, field=None, validator_id=None):
...
def make_generate_parser_error(datafile, line_number):
    ...
    def generate(schema, error_category, error_message, record=None, field=None, validator_id=None):
...
def make_generate_case_consistency_parser_error(datafile):
    ...
    def generate(schema, error_category, error_message, line_number=None, record=None, field=None, validator_id=None):
        return generate_parser_error(
            datafile=datafile,
            line_number=line_number,
            schema=schema,
