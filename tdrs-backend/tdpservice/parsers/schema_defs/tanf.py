...
def t2_schema():
    ...
    adult_data_schema.add_fields(
        [
            ...
            ('ITEM36C_RECEIVES_AID_TOTALLY_DISABLED_UNDER_TITLE_XIV_APDT',
             1, 48, 48, "Alphanumeric"),
            ('ITEM36D_RECEIVES_AID_TO_THE_AGED, BLIND', 1, 49, 49, "Alphanumeric"),
            ('ITEM36E_RECEIVES_SUPPLEMENTAL_SECURITY_INCOME_TITLE_XVI_SSI', 1, 50, 50, "Alphanumeric"),
...
def t3_schema():
    ...
    children_data_schema.add_fields(
        [
            ...
            ('ITEM72A_RECEIVES_BENEFITS_UNDER_NON_SSA_PROGRAMS', 1, 45, 45,
             "Alphanumeric"),
            ...
            ('ITEM72A_RECEIVES_BENEFITS_UNDER_NON_SSA_PROGRAMS', 1, 86, 86,
             "Alphanumeric"),
