    ...
    RowSchema(
        ...
        fields=[
            ...
            Field(item="36B", name='FED_DISABILITY_STATUS', type='number', startIndex=46, endIndex=47, required=True,
                  validators=[validators.oneOf([1, 2])]),
            Field(item="36C", name='DISABLED_TITLE_XIVAPDT', type='string', startIndex=47, endIndex=48, required=False,
            ...
            Field(item="43", name='COOPERATION_CHILD_SUPPORT', type='number', startIndex=58, endIndex=59,
                  required=False, validators=[validators.or_validators(validators.oneOf([0, 1, 2, 9]),
                                                                       validators.numIsBlank()),]),
            ...
            Field(item="46", name='CURRENT_MONTH_STATE_EXEMPT', type='number', startIndex=64, endIndex=65,
                  required=False, validators=[validators.or_validators(validators.isInLimits(0, 9),
                                                                       validators.numIsBlank()),]),
            ...
            Field(item="57A", name='VOCATIONAL_ED_TRAINING_HOP', type='string', startIndex=96, endIndex=98,
                  required=False, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                       validators.isBlank()),]),
            ...
            Field(item="66A", name='UNEARNED_INCOME_TAX_CREDIT', type='string', startIndex=136, endIndex=140,
                  required=False, validators=[validators.or_validators(validators.isInStringRange(0, 9999),
                                                                       validators.isBlank()),]),
