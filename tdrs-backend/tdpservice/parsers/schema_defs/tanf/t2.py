    ...
    RowSchema(
        ...
        fields=[
            ...
            EncryptedField(decryption_func=tanf_ssn_decryption_func, item="33", name='SSN', type='string',
                           ...
                           validators=[validators.notOneOf(("000000000", "111111111", "222222222",
                                                            "333333333", "444444444", "555555555",
                                                            "666666666", "777777777", "888888888",
                                                            "999999999"))]),
            ...
            Field(item="36B", name='FED_DISABILITY_STATUS', type='number', startIndex=46, endIndex=47, required=True,
                  validators=[validators.oneOf([1, 2])]),
            Field(item="36C", name='DISABLED_TITLE_XIVAPDT', type='number', startIndex=47, endIndex=48, required=True,
