...
t2 = RowSchema(
    ...
    fields=[
        ...
        Field(name='ITEM34B_AMERICAN_INDIAN_OR_ALASKA_NATIVE', type='string', startIndex=39, endIndex=40,
              required=True, validators=[]),
        Field(name='ITEM34C_ASIAN', type='string', startIndex=40, endIndex=41, required=True, validators=[
        ]),
        Field(name='ITEM34D_BLACK_OR_AFRICAN_AMERICAN', type='string', startIndex=41, endIndex=42, required=True,
              validators=[]),
        Field(name='ITEM34E_NATIVE_HAWAIIAN_OR_OTHER_PACIFIC_ISLANDER', type='string', startIndex=42, endIndex=43,
              required=True, validators=[]),
        ...
        Field(name='SUBSIDIZED_PUBLIC_EMPLOYMENT', type='string', startIndex=74, endIndex=76, required=True,
              validators=[]),
        Field(name='ITEM53A_HOURS_OF_PARTICIPATION', type='string', startIndex=76, endIndex=78, required=True,
              validators=[]),
        ...
        Field(name='ITEM55A_HOURS_OF_PARTICIPATION', type='string', startIndex=84, endIndex=86, required=True,
              validators=[]),
        ...
        Field(name='ITEM56A_HOURS_OF_PARTICIPATION', type='string', startIndex=90, endIndex=92, required=True,
              validators=[]),
        ...
        Field(name='ITEM57A_HOURS_OF_PARTICIPATION', type='string', startIndex=96, endIndex=98, required=False,
              validators=[]),
        Field(name='ITEM57B_EXCUSED_ABSENCES', type='string', startIndex=98, endIndex=100, required=False,
              validators=[]),
        Field(name='ITEM57C_HOLIDAYS', type='string', startIndex=100, endIndex=102, required=False, validators=[]),
        Field(name='ITEM58A_HOURS_OF_PARTICIPATION', type='string', startIndex=102, endIndex=104, required=False,
              validators=[]),
        Field(name='ITEM58B_EXCUSED_ABSENCES', type='string', startIndex=104, endIndex=106, required=False,
              validators=[]),
        Field(name='ITEM58C_HOLIDAYS', type='string', startIndex=106, endIndex=108, required=False, validators=[]),
        Field(name='ITEM59A_HOURS_OF_PARTICIPATION', type='string', startIndex=108, endIndex=110, required=False,
              validators=[]),
        Field(name='ITEM59B_EXCUSED_ABSENCES', type='string', startIndex=110, endIndex=112, required=False,
              validators=[]),
        Field(name='ITEM59C_HOLIDAYS', type='string', startIndex=112, endIndex=114, required=False, validators=[]),
        Field(name='ITEM60A_HOURS_OF_PARTICIPATION', type='string', startIndex=114, endIndex=116, required=False,
              validators=[]),
        Field(name='ITEM60B_EXCUSED_ABSENCES', type='string', startIndex=116, endIndex=118, required=False,
              validators=[]),
        Field(name='ITEM60C_HOLIDAYS', type='string', startIndex=118, endIndex=120, required=False, validators=[]),
        Field(name='ITEM61A_HOURS_OF_PARTICIPATION', type='string', startIndex=120, endIndex=122, required=False,
              validators=[]),
        Field(name='ITEM61B_EXCUSED_ABSENCES', type='string', startIndex=122, endIndex=124, required=False,
              validators=[]),
        ...
        Field(name='AMOUNT_OF_EARNED_INCOME', type='string', startIndex=132, endIndex=136, required=False,
              validators=[]),
        Field(name='ITEM66A_EARNED_INCOME_TAX_CREDIT', type='string', startIndex=136, endIndex=140, required=False,
              validators=[]),
        Field(name='ITEM66B_SOCIAL_SECURITY', type='string', startIndex=140, endIndex=144, required=False,
              validators=[]),
        Field(name='ITEM66C_SSI', type='string', startIndex=144, endIndex=148, required=False, validators=[]),
        Field(name='ITEM66D_WORKERS_COMPENSATION', type='string', startIndex=148, endIndex=152, required=False,
              validators=[]),
        Field(name='ITEM66E_OTHER_UNEARNED_INCOME', type='string', startIndex=152, endIndex=156, required=False,
              validators=[]),
    ],
)
