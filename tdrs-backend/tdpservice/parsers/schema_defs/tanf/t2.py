        ...
        RowSchema(
            ...
            postparsing_validators=[
                ...
                validators.if_then_validator(
                    ...
                    result_field="SSN",
                    result_function=validators.notOneOf(
                        (
                            "000000000",
                            "111111111",
                            "222222222",
                ...
                validators.if_then_validator(
                    ...
                    result_function=validators.oneOf((1, 2, 3, 4, 5)),
                ),
                validators.if_then_validator(
                    condition_field="FAMILY_AFFILIATION",
                    condition_function=validators.isInLimits(1, 3),
                ...
                validators.if_then_validator(
                    ...
                    result_function=validators.notMatches(0),
                ),
                validators.if_then_validator(
                    condition_field="FAMILY_AFFILIATION",
                    condition_function=validators.isInLimits(1, 3),
                ...
                validators.if_then_validator(
                    condition_field="FAMILY_AFFILIATION",
                    condition_function=validators.matches(1),
                    result_field="MONTHS_FED_TIME_LIMIT",
                    result_function=validators.isLargerThan(1),
                ),
                validators.if_then_validator(
                    condition_field="RELATIONSHIP_HOH",
            ...
            fields=[
                ...
                EncryptedField(
                    decryption_func=tanf_ssn_decryption_func,
                    item=33,
                    name="SSN",
                    type="string",
                    startIndex=29,
                ...
                Field(
                    ...
                    validators=[
                        validators.or_validators(
                            validators.isInLimits(0, 9), validators.matches([12])
                        )
                    ],
                ),
                Field(
                    ...
                    endIndex=70,
                    required=True,
                    validators=[validators.oneOf([1, 2, 5, 7, 9, 15, 17, 18, 19, 99])],
                ),
                Field(
                    item="50",
