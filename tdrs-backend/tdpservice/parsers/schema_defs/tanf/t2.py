    ...
    RowSchema(
        ...
        fields=[
            ...
            Field(item="51", name='SUB_PRIVATE_EMPLOYMENT', type='string', startIndex=72, endIndex=74,
                  ...
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="52", name='SUB_PUBLIC_EMPLOYMENT', type='string', startIndex=74, endIndex=76, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="53A", name='WORK_EXPERIENCE_HOP', type='string', startIndex=76, endIndex=78, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="53B", name='WORK_EXPERIENCE_EA', type='string', startIndex=78, endIndex=80, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="53C", name='WORK_EXPERIENCE_HOL', type='string', startIndex=80, endIndex=82, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="54", name='OJT', type='string', startIndex=82, endIndex=84, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99), validators.isNone()),]),
            Field(item="55A", name='JOB_SEARCH_HOP', type='string', startIndex=84, endIndex=86, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="55B", name='JOB_SEARCH_EA', type='string', startIndex=86, endIndex=88, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="55C", name='JOB_SEARCH_HOL', type='string', startIndex=88, endIndex=90, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="56A", name='COMM_SERVICES_HOP', type='string', startIndex=90, endIndex=92, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="56B", name='COMM_SERVICES_EA', type='string', startIndex=92, endIndex=94, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="56C", name='COMM_SERVICES_HOL', type='string', startIndex=94, endIndex=96, can_be_empty=True,
                  required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                      validators.isNone()),]),
            Field(item="57A", name='VOCATIONAL_ED_TRAINING_HOP', type='string', startIndex=96, endIndex=98,
                  can_be_empty=True, required=True, validators=[
                      validators.or_validators(validators.isInStringRange(0, 99), validators.isNone()),]),
