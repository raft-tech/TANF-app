        ...
        RowSchema(
            ...
            fields=[
                ...
                Field(
                    item="36E",
                    name="RECEIVE_SSI",
                    friendly_name="receive social security income",
                    type="number",
                    startIndex=49,
                    endIndex=50,
                    required=True,
                ...
                Field(
                    ...
                    friendly_name="months of federal time limit",
                    type="string",
                    startIndex=59,
                    endIndex=62,
                    required=False,
                ...
                Field(
                    ...
                    friendly_name="work experience - hours of leave",
                    type="string",
                    startIndex=80,
                    endIndex=82,
                    required=False,
                ...
                Field(
                    item="55C",
                    name="JOB_SEARCH_HOL",
                    friendly_name="job search - hours of leave",
                    type="string",
                    startIndex=88,
                    endIndex=90,
                    required=False,
                ...
                Field(
                    ...
                    friendly_name="education no high school diploma - hours of leave",
                    type="string",
                    startIndex=112,
                    endIndex=114,
                    required=False,
                ...
                Field(
                    ...
                    friendly_name="school attendence - hours of participation",
                    type="string",
                    startIndex=114,
                    endIndex=116,
                    required=False,
                ...
                Field(
                    ...
                    friendly_name="school attendence - excused absence",
                    type="string",
                    startIndex=116,
                    endIndex=118,
                    required=False,
                ...
                Field(
                    ...
                    friendly_name="school attendance - hours of leave",
                    type="string",
                    startIndex=118,
                    endIndex=120,
                    required=False,
                ...
                Field(
                    item="61C",
                    name="PROVIDE_CC_HOL",
                    friendly_name="provide child care - hours of leave",
                    type="string",
                    startIndex=124,
                    endIndex=126,
                    required=False,
                ...
                Field(
                    item="66C",
                    name="UNEARNED_SSI",
                    friendly_name="unearned social security income",
                    type="string",
                    startIndex=144,
                    endIndex=148,
                    required=True,
