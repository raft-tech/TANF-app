      ...
      schemas=[
        RowSchema(
          ...
          fields=[
              ...
              Field(name='NONCUSTODIAL_PARENT', type='number', startIndex=20, endIndex=21, required=True,
                    validators=[]),
              ...
              Field(name='FED_DISABILITY_STATUS', type='string', startIndex=46, endIndex=47, required=True,
                    validators=[]),
              Field(name='DISABLED_TITLE_XIVAPDT', type='string', startIndex=47, endIndex=48, required=True,
                    validators=[]),
              ...
              Field(name='PARENT_WITH_MINOR_CHILD', type='string', startIndex=53, endIndex=54, required=True,
                    validators=[]),
              Field(name='NEEDS_PREGNANT_WOMAN', type='string', startIndex=54, endIndex=55, required=True,
                    validators=[]),
              ...
              Field(name='WORK_ELIGIBLE_INDICATOR', type='string', startIndex=66, endIndex=68, required=True,
                    validators=[]),
              ...
              Field(name='SUB_PRIVATE_EMPLOYMENT', type='string', startIndex=72, endIndex=74, required=True,
                    validators=[]),
              Field(name='SUB_PUBLIC_EMPLOYMENT', type='string', startIndex=74, endIndex=76, required=True,
                    validators=[]),
              Field(name='WORK_EXPERIENCE_HOP', type='string', startIndex=76, endIndex=78, required=True,
                    validators=[]),
              Field(name='WORK_EXPERIENCE_EA', type='string', startIndex=78, endIndex=80, required=True, validators=[]),
              Field(name='WORK_EXPERIENCE_HOL', type='string', startIndex=80, endIndex=82, required=True,
                    validators=[]),
              ...
              Field(name='ED_NO_HIGH_SCHOOL_DIPL_HOL', type='string', startIndex=112, endIndex=114, required=False,
                    validators=[]),
              Field(name='SCHOOL_ATTENDENCE_HOP', type='string', startIndex=114, endIndex=116, required=False,
                    validators=[]),
              Field(name='SCHOOL_ATTENDENCE_EA', type='string', startIndex=116, endIndex=118, required=False,
                    validators=[]),
              Field(name='SCHOOL_ATTENDENCE_HOL', type='string', startIndex=118, endIndex=120, required=False,
                    validators=[]),
              ...
              Field(name='OTHER_WORK_ACTIVITIES', type='string', startIndex=126, endIndex=128, required=False,
                    validators=[]),
              ...
              Field(name='UNEARNED_WORKERS_COMP', type='string', startIndex=148, endIndex=152, required=False,
                    validators=[]),
              Field(name='OTHER_UNEARNED_INCOME', type='string', startIndex=152, endIndex=156, required=False,
                    validators=[]),
          ],
        )
      ]
