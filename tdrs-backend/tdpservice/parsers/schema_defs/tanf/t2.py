...
t2 = RowSchema(
    ...
    fields=[
        ...
        Field(name='COMMUNITY_SVS_HOURS_OF_PARTICIPATION', type='string', startIndex=90, endIndex=92, required=True,
              validators=[]),
        Field(name='COMMUNITY_SVS_EXCUSED_ABSENCES', type='string', startIndex=92, endIndex=94, required=True,
              validators=[]),
        ...
        Field(name='VOCATIONAL_ED_EXCUSED_ABSENCES', type='string', startIndex=98, endIndex=100, required=False,
              validators=[]),
        Field(name='VOCATIONAL_ED_HOLIDAYS', type='string', startIndex=100, endIndex=102, required=False,
              validators=[]),
        ...
        Field(name='EDUCATION_RELATED_HOURS_OF_PARTICIPATION', type='string', startIndex=108, endIndex=110,
              required=False, validators=[]),
        Field(name='EDUCATION_RELATED_EXCUSED_ABSENCES', type='string', startIndex=110, endIndex=112, required=False,
              validators=[]),
        Field(name='EDUCATION_RELATED_HOLIDAYS', type='string', startIndex=112, endIndex=114, required=False,
              validators=[]),
        Field(name='SCHOOL_ATTENDENCE_HOURS_OF_PARTICIPATION', type='string', startIndex=114, endIndex=116,
              required=False, validators=[]),
        Field(name='SCHOOL_ATTENDENCE_EXCUSED_ABSENCES', type='string', startIndex=116, endIndex=118, required=False,
              validators=[]),
        Field(name='SCHOOL_ATTENDENCE_HOLIDAYS', type='string', startIndex=118, endIndex=120, required=False,
              validators=[]),
        ...
        Field(name='AMOUNT_OF_EARNED_INCOME', type='string', startIndex=132, endIndex=136, required=False,
              validators=[]),
        Field(name='UNEARNED_INCOME_EARNED_INCOME_TAX_CREDIT', type='string', startIndex=136, endIndex=140,
              required=False, validators=[]),
