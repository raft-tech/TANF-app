...
t2 = SchemaManager(schemas=[
    RowSchema(
        ...
        fields=[
            ...
            Field(item="34A", name='RACE_HISPANIC', type='number', startIndex=38, endIndex=39, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 2),
                                                       validators.isNone()),]),
            Field(item="34B", name='RACE_AMER_INDIAN', type='number', startIndex=39, endIndex=40, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 2),
                                                       validators.isNone()),]),
            Field(item="34C", name='RACE_ASIAN', type='number', startIndex=40, endIndex=41, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 2),
                                                       validators.isNone()),]),
            Field(item="34D", name='RACE_BLACK', type='number', startIndex=41, endIndex=42, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 2),
                                                       validators.isNone()),]),
            Field(item="34E", name='RACE_HAWAIIAN', type='number', startIndex=42, endIndex=43, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 2),
                                                       validators.isNone()),]),
            Field(item="34F", name='RACE_WHITE', type='number', startIndex=43, endIndex=44, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 2),
                                                       validators.isNone()),]),
            ...
            Field(item="36C", name='DISABLED_TITLE_XIVAPDT', type='string', startIndex=47, endIndex=48,
                  can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.oneOf(["1", "2"]), validators.isNone())]),
            Field(item="36D", name='AID_AGED_BLIND', type='number', startIndex=48, endIndex=49,
                  can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isLargerThanOrEqualTo(0),
                                                       validators.isNone()),]),
            Field(item="36E", name='RECEIVE_SSI', type='number', startIndex=49, endIndex=50, required=True,
                  validators=[validators.oneOf([1, 2]),]),
            Field(item="37", name='MARITAL_STATUS', type='number', startIndex=50, endIndex=51, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 5),
                                                       validators.isNone()),]),
            ...
            Field(item="39", name='PARENT_WITH_MINOR_CHILD', type='number', startIndex=53, endIndex=54, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 3),
                                                       validators.isNone()),]),
            Field(item="40", name='NEEDS_PREGNANT_WOMAN', type='number', startIndex=54, endIndex=55, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 9),
                                                       validators.isNone()),]),
            Field(item="41", name='EDUCATION_LEVEL', type='string', startIndex=55, endIndex=57, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 16),
                                                       validators.isInStringRange(98, 99),
                                                       validators.isNone())]),
            Field(item="42", name='CITIZENSHIP_STATUS', type='number', startIndex=57, endIndex=58, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.oneOf([0, 1, 2, 9]),
                                                       validators.isNone()),]),
            Field(item="43", name='COOPERATION_CHILD_SUPPORT', type='number', startIndex=58, endIndex=59,
                  can_be_empty=True, required=True, validators=[validators.or_validators(validators.oneOf([0, 1, 2, 9]),
                                                                       validators.isNone()),]),
            Field(item="44", name='MONTHS_FED_TIME_LIMIT', type='string', startIndex=59, endIndex=62, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 999),
                                                       validators.isNone()),]),
            Field(item="45", name='MONTHS_STATE_TIME_LIMIT', type='string', startIndex=62, endIndex=64,
                  can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="46", name='CURRENT_MONTH_STATE_EXEMPT', type='number', startIndex=64, endIndex=65,
                  can_be_empty=True, required=True, validators=[validators.or_validators(validators.isInLimits(0, 9),
                                                                       validators.isNone()),]),
            Field(item="47", name='EMPLOYMENT_STATUS', type='number', startIndex=65, endIndex=66, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInLimits(0, 3),
                                                       validators.isNone()),]),
            ...
            Field(item="49", name='WORK_PART_STATUS', type='string', startIndex=68, endIndex=70, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(
                                    validators.oneOf(['01', '02', '05', '07', '09', '15',
                                                      '16', '17', '18', '19', '99']),
                                    validators.isNone()),]),
            Field(item="50", name='UNSUB_EMPLOYMENT', type='string', startIndex=70, endIndex=72, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="51", name='SUB_PRIVATE_EMPLOYMENT', type='string', startIndex=72, endIndex=74, can_be_empty=True,
                  required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="52", name='SUB_PUBLIC_EMPLOYMENT', type='string', startIndex=74, endIndex=76, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="53A", name='WORK_EXPERIENCE_HOP', type='string', startIndex=76, endIndex=78, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="53B", name='WORK_EXPERIENCE_EA', type='string', startIndex=78, endIndex=80, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="53C", name='WORK_EXPERIENCE_HOL', type='string', startIndex=80, endIndex=82, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="54", name='OJT', type='string', startIndex=82, endIndex=84, can_be_empty=True, required=True, validators=[
                validators.or_validators(
                    validators.isInStringRange(0, 99),
                    validators.isNone()),]),
            Field(item="55A", name='JOB_SEARCH_HOP', type='string', startIndex=84, endIndex=86, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="55B", name='JOB_SEARCH_EA', type='string', startIndex=86, endIndex=88, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="55C", name='JOB_SEARCH_HOL', type='string', startIndex=88, endIndex=90, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="56A", name='COMM_SERVICES_HOP', type='string', startIndex=90, endIndex=92, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="56B", name='COMM_SERVICES_EA', type='string', startIndex=92, endIndex=94, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="56C", name='COMM_SERVICES_HOL', type='string', startIndex=94, endIndex=96, can_be_empty=True, required=True,
                  validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                       validators.isNone()),]),
            Field(item="57A", name='VOCATIONAL_ED_TRAINING_HOP', type='string', startIndex=96, endIndex=98,
                  can_be_empty=True, required=True, validators=[validators.or_validators(validators.isInStringRange(0, 99),
                                                                       validators.isNone()),]),
