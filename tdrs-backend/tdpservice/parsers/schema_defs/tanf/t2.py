...
t2 = RowSchema(
    ...
    fields=[
        ...
        Field(name='RACE_AMERICAN_INDIAN_OR_ALASKA_NATIVE', type='string', startIndex=39, endIndex=40, required=True,
              validators=[]),
        ...
        Field(name='RECEIVES_FEDERAL_DISABILITY_INSURANCE_OASDI_PROGRAM', type='string', startIndex=45, endIndex=46,
              required=True, validators=[]),
        Field(name='RECEIVES_BENEFITS_BASED_ON_FEDERAL_DISABILITY_STATUS', type='string', startIndex=46, endIndex=47,
              required=True, validators=[]),
        Field(name='RECEIVES_AID_TOTALLY_DISABLED_UNDER_TITLE_XIV_APDT', type='string', startIndex=47, endIndex=48,
              required=True, validators=[]),
        Field(name='RECEIVES_AID_TO_THE_AGED', type='string', startIndex=48, endIndex=49, required=True, validators=[]),
        Field(name='RECEIVES_SUPPLEMENTAL_SECURITY_INCOME_TITLE_XVI_SSI', type='string', startIndex=49, endIndex=50,
              required=True, validators=[]),
        ...
        Field(name='NEEDS_OF_A_PREGNANT_WOMAN', type='string', startIndex=54, endIndex=55, required=True,
              validators=[]),
        ...
        Field(name='COOPERATION_WITH_CHILD_SUPPORT', type='string', startIndex=58, endIndex=59, required=True,
              validators=[]),
        Field(name='NUMBER_OF_COUNTABLE_MONTHS', type='string', startIndex=59, endIndex=62, required=True,
              validators=[]),
        ...
        Field(name='WORK_ELIGIBLE_INDIVIDUAL_INDICATOR', type='string', startIndex=66, endIndex=68, required=True,
              validators=[]),
        Field(name='WORK_PARTICIPATION_STATUS', type='string', startIndex=68, endIndex=70, required=True,
              validators=[]),
        ...
        Field(name='WORK_EXP_HOURS_OF_PARTICIPATION', type='string', startIndex=76, endIndex=78, required=True,
              validators=[]),
        Field(name='WORK_EXP_EXCUSED_ABSENCES', type='string', startIndex=78, endIndex=80, required=True,
              validators=[]),
        ...
        Field(name='JOB_SEARCH_HOURS_OF_PARTICIPATION', type='string', startIndex=84, endIndex=86, required=True,
              validators=[]),
        Field(name='JOB_SEARCH_EXCUSED_ABSENCES', type='string', startIndex=86, endIndex=88, required=True,
              validators=[]),
