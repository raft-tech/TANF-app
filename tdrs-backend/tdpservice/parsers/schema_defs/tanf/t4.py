          ...
          fields=[
              ...
              Field(item="6", name='CASE_NUMBER', type='string', startIndex=8, endIndex=19,
                    required=True, validators=[validators.isAlphaNumeric(),
                                               ...
                                               validators.notEmpty()]),
              Field(item="2", name='COUNTY_FIPS_CODE', type='number', startIndex=19, endIndex=22,
                    required=True, validators=[validators.isInLimits(1, 999)]),
              Field(item="5", name='STRATUM', type='number', startIndex=22, endIndex=24,
                    required=True, validators=[validators.isInLimits(1, 99)]),
              ...
              Field(item="9", name='CLOSURE_REASON', type='number', startIndex=30, endIndex=32,
                    required=True, validators=[validators.or_validators(validators.isInLimits(1, 19),
