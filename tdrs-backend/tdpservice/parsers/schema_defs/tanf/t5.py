        ...
        RowSchema(
          ...
          fields=[
              ...
              Field(item="19D", name='REC_AID_AGED_BLIND', type='number', startIndex=47, endIndex=48,
                    required=True, validators=[]),
              Field(item="19E", name='RECEIVE_SSI', type='number', startIndex=48, endIndex=49,
                    required=True, validators=[]),
              ...
              Field(item="21", name='RELATIONSHIP_HOH', type='string', startIndex=50, endIndex=52,
                    required=True, validators=[]),
              Field(item="22", name='PARENT_WITH_MINOR_CHILD', type='number', startIndex=52, endIndex=53,
                    required=True, validators=[]),
              Field(item="23", name='NEEDS_PREGNANT_WOMAN', type='number', startIndex=53, endIndex=54,
                    required=True, validators=[]),
