...
child_one = RowSchema(
    ...
    fields=[
        ...
        Field(name='RECEIVES_BENEFITS_UNDER_NON_SSA_PROGRAMS', type='string', startIndex=44, endIndex=45, required=True,
              validators=[]),
...
child_two = RowSchema(
    ...
    fields=[
        ...
        Field(name='RECEIVES_BENEFITS_UNDER_NON_SSA_PROGRAMS', type='string', startIndex=85, endIndex=86, required=True,
              validators=[]),
