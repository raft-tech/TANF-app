        ...
        RowSchema(
            ...
            postparsing_validators=[
                validators.if_then_validator(
                    condition_field="RECEIVES_FOOD_STAMPS",
                    condition_function=validators.matches(1),
                    result_field="AMT_FOOD_STAMP_ASSISTANCE",
                    result_function=validators.isLargerThan(0),
                ),
                validators.if_then_validator(
                    condition_field="RECEIVES_SUB_CC",
                    condition_function=validators.notMatches(3),
                    result_field="AMT_SUB_CC",
                    result_function=validators.isLargerThan(0),
                ),
                validators.if_then_validator(
