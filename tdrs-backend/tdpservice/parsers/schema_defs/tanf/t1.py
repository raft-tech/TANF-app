...
t1 = RowSchema(
    ...
    fields=[
        ...
        Field(item="26AVII", name='OTHER_SANCTION', type='number', startIndex=101, endIndex=102,
              required=True, validators=[]),
        Field(item="26BI", name='RECOUPMENT_PRIOR_OVRPMT', type='number', startIndex=102, endIndex=106,
              required=True, validators=[]),
        Field(item="26BII", name='OTHER_TOTAL_REDUCTIONS', type='number', startIndex=106, endIndex=110,
              required=True, validators=[]),
        Field(item="26BIII", name='FAMILY_CAP', type='number', startIndex=110, endIndex=111,
              required=True, validators=[]),
        Field(item="26BIV", name='REDUCTIONS_ON_RECEIPTS', type='number', startIndex=111, endIndex=112,
              required=True, validators=[]),
        Field(item="26BV", name='OTHER_NON_SANCTION', type='number', startIndex=112, endIndex=113,
              required=True, validators=[]),
