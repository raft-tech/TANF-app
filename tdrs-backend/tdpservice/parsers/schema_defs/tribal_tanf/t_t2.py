...
t_t2 = SchemaManager(schemas=[
    RowSchema(
        ...
        fields=[
            ...
            Field(item="39", name='PARENT_MINOR_CHILD', type='number', startIndex=53, endIndex=54, required=False,
            ...
            Field(item="47", name='EMPLOYMENT_STATUS', type='number', startIndex=65, endIndex=66, required=False,
                  validators=[validators.isInLimits(0, 3),]),
            Field(item="48", name='WORK_PART_STATUS', type='string', startIndex=66, endIndex=68, required=False,
                  validators=[validators.or_validators(validators.isInStringRange(0, 3),
                                                       validators.isInStringRange(5, 9),
                                                       validators.isInStringRange(11, 19),
                                                       validators.matches('99'))]),
            Field(item="49", name='UNSUB_EMPLOYMENT', type='string', startIndex=68, endIndex=70, required=False,
                  validators=[validators.isInStringRange(0, 99),]),
            Field(item="50", name='SUB_PRIVATE_EMPLOYMENT', type='string', startIndex=70, endIndex=72, required=False,
                  validators=[validators.isInStringRange(0, 99),]),
            Field(item="51", name='SUB_PUBLIC_EMPLOYMENT', type='string', startIndex=72, endIndex=74, required=False,
                  validators=[validators.isInStringRange(0, 99),]),
            Field(item="52", name='WORK_EXPERIENCE', type='string', startIndex=74, endIndex=76, required=False,
                  validators=[validators.isInStringRange(0, 99),]),
            Field(item="53", name='OJT', type='string', startIndex=76, endIndex=78, required=False, validators=[
                  validators.isInStringRange(0, 99),
                  ]),
            Field(item="54", name='JOB_SEARCH', type='string', startIndex=78, endIndex=80, required=False,
                  validators=[validators.isInStringRange(0, 99),]),
            Field(item="55", name='COMM_SERVICES', type='string', startIndex=80, endIndex=82, required=False,
                  validators=[validators.isInStringRange(0, 99),]),
            ...
            Field(item="65C", name='UNEARNED_SSI', type='string', startIndex=110, endIndex=114, required=True,
                  validators=[validators.isInStringRange(0, 9999),]),
            Field(item="65D", name='UNEARNED_WORKERS_COMP', type='string', startIndex=114, endIndex=118, required=True,
                  validators=[validators.isInStringRange(0, 9999),]),
