...
class Common(Configuration):
    ...
    CSRF_TRUSTED_ORIGINS = ['.app.cloud.gov', 'https://tanfdata.acf.hhs.gov']
    ...
    CSP_DEFAULT_SRC = ("'self'", "*.cloud.gov", "https://tanfdata.acf.hhs.gov")
    CSP_SCRIPT_SRC = ("'self'", s3_src)
    CSP_IMG_SRC = ("'self'", "data:", s3_src)
    CSP_FONT_SRC = ("'self'", s3_src)
    CSP_CONNECT_SRC = ("'self'", "*.cloud.gov", "https://tanfdata.acf.hhs.gov")
