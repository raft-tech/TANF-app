...
class Common(Configuration):
    ...
    OIDC_OP_AUTHORIZATION_ENDPOINT = (
        f"{KC_EXTERNAL_URL}/realms/{KC_REALM}/protocol/openid-connect/auth"
    )
    ...
    OIDC_OP_TOKEN_ENDPOINT = (
        f"{KC_INTERNAL_URL}/realms/{KC_REALM}/protocol/openid-connect/token"
    )
    OIDC_OP_USER_ENDPOINT = (
        f"{KC_INTERNAL_URL}/realms/{KC_REALM}/protocol/openid-connect/userinfo"
    )
    OIDC_OP_JWKS_ENDPOINT = (
        f"{KC_INTERNAL_URL}/realms/{KC_REALM}/protocol/openid-connect/certs"
    )
