...
def t1_schema():
    ...
    #         ('21A', 'CASH_AMOUNT', 4, 56, 59, "Numeric", [t1_106, t1_107]),
    #         ('21B', 'NBR_MONTHS', 3, 60, 62, "Numeric", []),
    #         ('22A', 'CC_AMOUNT', 4, 63, 66, "Numeric", [t1_108, t1_109, t1_139]),
    #         ('22B', 'CHILDREN_COVERED', 2, 67, 68, "Numeric", []),
    #         ('22C', 'CC_NBR_MONTHS', 3, 69, 71, "Numeric", []),
    #         ('23A', 'TRANSP_AMOUNT', 4, 72, 75, "Numeric", [t1_110, t1_111]),
    #         ('23B', 'TRANSP_NBR_MONTHS', 3, 76, 78, "Numeric", []),
    #         ('24A', 'TRANSITION_SERVICES_AMOUNT', 4, 79, 82, "Numeric", [t1_112, t1_113]),
    #         ('24B', 'TRANSITION_NBR_MONTHS', 3, 83, 85, "Numeric", []),
    #         ('25A', 'OTHER_AMOUNT', 4, 86, 89, "Numeric", [t1_114, t1_115]),
    #         ('25B', 'OTHER_NBR_MONTHS', 3, 90, 92, "Numeric", []),
    #         ('26Ai', 'SANC_REDUCTION_AMT', 4, 93, 96, "Numeric", [t1_116, t1_117, t1_118]),
