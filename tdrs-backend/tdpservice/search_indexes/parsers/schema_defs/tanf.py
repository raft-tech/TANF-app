...
def t1_schema():
    ...
    return [
        ...
        row('4', 'RPT_MONTH_YEAR', 6, 3, 8, "Numeric", {'custom': [t1_006, t1_007]}),
        row('6', 'CASE_NUMBER', 11, 9, 19, "Alphanumeric"),
        row('2', 'COUNTY_FIPS_CODE', 3, 20, 22, "Numeric"),
        row('5', 'STRATUM', 2, 23, 24, "Numeric", {'gt': 0, 'lt': 100}),
        row('7', 'ZIP_CODE', 5, 25, 29, "Alphanumeric"),
        row('8', 'FUNDING_STREAM', 1, 30, 30, "Numeric", {'in': [1, 2]}),
        ...
        row('21A', 'CASH_AMOUNT', 4, 56, 59, "Numeric", {'custom': [t1_107]}),
        ...
        row('25A', 'OTHER_AMOUNT', 4, 86, 89, "Numeric", cat3_conditions={'primary': {'OTHER_AMOUNT': {'gt': 0}}, 'secondary': {'OTHER_NBR_MONTHS': {'gt': 0}}}),
