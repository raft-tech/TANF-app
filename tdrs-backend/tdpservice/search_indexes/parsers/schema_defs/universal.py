...
def get_header_schema():
    '''Returns the schema dictionary for the header record.
    ...
    header_schema = {
            ...
            'tribe_code':   {'type': 'string', 'required': False, 'regex': '^([0-9]{3}|[ ]{3})$'},  # 3 digits or 3 spaces
...
def get_trailer_schema():
    '''Returns the schema dictionary for the trailer record.
