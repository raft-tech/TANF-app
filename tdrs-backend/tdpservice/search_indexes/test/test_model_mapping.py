...
def test_can_create_and_index_tanf_t2_submission():
    ...
    submission = models.tanf.TANF_T2.objects.create(
        ...
        RACE_ASIAN=1,
        RACE_BLACK_OR_AFRICAN_AMERICAN=1,
        RACE_NATIVE_HAWAIIAN_OR_OTHER_PACIFIC_ISLANDER=1,
        RACE_WHITE=1,
        GENDER=1,
        RECEIVES_FEDERAL_DISABILITY_INSURANCE_OASDI_PROGRAM=1,
        RECEIVES_BENEFITS_BASED_ON_FEDERAL_DISABILITY_STATUS=1,
        RECEIVES_AID_TOTALLY_DISABLED_UNDER_TITLE_XIV_APDT=1,
        RECEIVES_AID_TO_THE_AGED=1,
        RECEIVES_SUPPLEMENTAL_SECURITY_INCOME_TITLE_XVI_SSI=1,
        MARITAL_STATUS=1,
        ...
        WORK_EXP_HOURS_OF_PARTICIPATION=1,
        WORK_EXP_EXCUSED_ABSENCES=1,
        WORK_EXP_HOLIDAYS=1,
        ON_THE_JOB_TRAINING=1,
        JOB_SEARCH_HOURS_OF_PARTICIPATION=1,
        JOB_SEARCH_EXCUSED_ABSENCES=1,
        JOB_SEARCH_HOLIDAYS=1,
        COMMUNITY_SVS_HOURS_OF_PARTICIPATION=1,
        COMMUNITY_SVS_EXCUSED_ABSENCES=1,
        COMMUNITY_SVS_HOLIDAYS=1,
        VOCATIONAL_ED_HOURS_OF_PARTICIPATION=1,
        VOCATIONAL_ED_EXCUSED_ABSENCES=1,
        VOCATIONAL_ED_HOLIDAYS=1,
        JOB_SKILLS_HOURS_OF_PARTICIPATION=1,
        JOB_SKILLS_EXCUSED_ABSENCES=1,
        JOB_SKILLS_HOLIDAYS=1,
        EDUCATION_RELATED_HOURS_OF_PARTICIPATION=1,
        EDUCATION_RELATED_EXCUSED_ABSENCES=1,
        EDUCATION_RELATED_HOLIDAYS=1,
        SCHOOL_ATTENDENCE_HOURS_OF_PARTICIPATION=1,
        SCHOOL_ATTENDENCE_EXCUSED_ABSENCES=1,
        SCHOOL_ATTENDENCE_HOLIDAYS=1,
        CHILD_CARE_HOURS_OF_PARTICIPATION=1,
        CHILD_CARE_EXCUSED_ABSENCES=1,
        CHILD_CARE_HOLIDAYS=1,
        ...
        UNEARNED_INCOME_EARNED_INCOME_TAX_CREDIT=1,
        UNEARNED_INCOME_SOCIAL_SECURITY=1,
        UNEARNED_INCOME_SSI=1,
        UNEARNED_INCOME_WORKERS_COMPENSATION=1,
        UNEARNED_INCOME_OTHER_UNEARNED_INCOME=1
    )
...
def test_can_create_and_index_tanf_t3_submission():
    ...
    submission = models.tanf.TANF_T3.objects.create(
        ...
        RACE_WHITE=1,
        GENDER=1,
        RECEIVES_BENEFITS_UNDER_NON_SSA_PROGRAMS=1,
        RECEIVES_SSI_UNDER_TITLE_XVI_SSI=1,
        RELATIONSHIP_TO_HEAD_OF_HOUSEHOLD=1,
        PARENT_WITH_MINOR_CHILD=1,
        EDUCATION_LEVEL=1,
