...
class T1DataSubmissionDocument(Document):
    ...
    class Django:
        ...
        fields = [
            ...
            'food_stamp_amount',
            'receives_sub_child_care',
            'child_care_amount',
            'child_support_amount',
            'family_cash_recources',
            'family_cash_amount',
            'family_cash_nbr_month',
            'tanf_child_care_amount',
            'children_covered',
            'child_care_nbr_months',
            'transportation_amount',
            'transport_nbr_months',
            'transition_services_amount',
            'transition_nbr_months',
            'other_amount',
            'other_nbr_months',
            'reduction_amount',
            'reduc_work_requirements',
            'reduc_adult_no_hs_diploma',
            'reduc_teen_not_in_school',
            'reduc_noncooperation_child_support',
            'reduc_irp_failure',
            'reduc_other_sanction',
            'reduc_prior_overpayment',
            'total_reduc_amount',
            'reduc_family_cap',
            'reduc_length_of_assist',
            'other_non_sanction',
            'waiver_control_grps',
            'tanf_family_exempt_time_limits',
            'tanf_new_child_only_family',
        ]
