...
class TANF_T5(models.Model):
    ...
    GENDER = models.IntegerField(null=True, blank=False)
    REC_OASDI_INSURANCE = models.FloatField(null=True, blank=False)
    REC_FEDERAL_DISABILITY = models.IntegerField(null=True, blank=False)
    REC_AID_TOTALLY_DISABLED = models.FloatField(null=True, blank=False)
    REC_AID_AGED_BLIND = models.FloatField(null=True, blank=False)
    REC_SSI = models.IntegerField(null=True, blank=False)
    MARITAL_STATUS = models.FloatField(null=True, blank=False)
    RELATIONSHIP_HOH = models.IntegerField(null=True, blank=False)
    ...
    COUNTABLE_MONTH_FED_TIME = models.FloatField(null=True, blank=False)
    COUNTABLE_MONTHS_STATE_TRIBE = models.FloatField(null=True, blank=False)
    EMPLOYMENT_STATUS = models.FloatField(null=True, blank=False)
    AMOUNT_EARNED_INCOME = models.IntegerField(null=True, blank=False)
    AMOUNT_UNEARNED_INCOME = models.IntegerField(null=True, blank=False)
