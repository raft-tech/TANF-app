...
class TANF_T2(models.Model):
    ...
    DOB = models.CharField(max_length=8, null=False, blank=False)
    SSN = models.CharField(max_length=9, null=False, blank=False)
    ITEM34A_HISPANIC_OR_LATINO = models.IntegerField(null=False, blank=False)
    ITEM34B_AMERICAN_INDIAN_OR_ALASKA_NATIVE = models.IntegerField(null=False, blank=False)
    ITEM34C_ASIAN = models.IntegerField(null=False, blank=False)
    ITEM34D_BLACK_OR_AFRICAN_AMERICAN = models.IntegerField(null=False, blank=False)
    ITEM34E_NATIVE_HAWAIIAN_OR_OTHER_PACIFIC_ISLANDER = models.IntegerField(null=False, blank=False)
    ITEM34F_WHITE = models.IntegerField(null=False, blank=False)
    GENDER = models.IntegerField(null=False, blank=False)
    ITEM36A_RECEIVES_FEDERAL_DISABILITY_INSURANCE_OASDI_PROGRAM = models.IntegerField(null=False, blank=False)
    ITEM36B_RECEIVES_BENEFITS_BASED_ON_FEDERAL_DISABILITY_STATUS = models.IntegerField(null=False, blank=False)
    ITEM36C_RECEIVES_AID_TO_THE_PERMANENTLY_AND_TOTALLY_DISABLED_UNDER_TITLE_XIV = models.IntegerField(null=False, blank=False)
    ITEM36D_RECEIVES_AID_TO_THE_AGED = models.IntegerField(null=False, blank=False)
    ITEM36E_RECEIVES_SUPPLEMENTAL_SECURITY_INCOME_UNDER_TITLE_XVI = models.IntegerField(null=False, blank=False)
    ...
    PARENT_WITH_MINOR_CHILD = models.IntegerField(null=False, blank=False)
    NEEDS_OF_A_PREGNANT_WOMAN = models.IntegerField(null=False, blank=False)
    EDUCATION_LEVEL = models.IntegerField(null=False, blank=False)
    CITIZENSHIP_STATUS = models.IntegerField(null=False, blank=False)
    COOPERATION_WITH_CHILD_SUPPORT = models.IntegerField(null=False, blank=False)
    NUMBER_OF_COUNTABLE_MONTHS = models.FloatField(null=False, blank=False)
    NUMBER_OF_COUNTABLE_MONTHS_REMAINING = models.FloatField(null=False, blank=False)
    CURRENT_MONTH_EXEMPT_FROM_STATE = models.IntegerField(null=False, blank=False)
    EMPLOYMENT_STATUS = models.IntegerField(null=False, blank=False)
    WORK_ELIGIBLE_INDIVIDUAL_INDICATOR = models.IntegerField(null=False, blank=False)
    WORK_PARTICIPATION_STATUS = models.IntegerField(null=False, blank=False)
    UNSUBSIDIZED_EMPLOYMENT = models.IntegerField(null=False, blank=False)
    SUBSIDIZED_PRIVATE_EMPLOYMENT = models.IntegerField(null=False, blank=False)
    SUBSIDIZED_PUBLIC_EMPLOYMENT = models.IntegerField(null=False, blank=False)
    ITEM53A_HOURS_OF_PARTICIPATION = models.IntegerField(null=False, blank=False)
    ITEM53B_EXCUSED_ABSENCES = models.IntegerField(null=False, blank=False)
    ITEM53C_HOLIDAYS = models.IntegerField(null=False, blank=False)
    ON_THE_JOB_TRAINING = models.IntegerField(null=False, blank=False)
    ITEM55A_HOURS_OF_PARTICIPATION = models.IntegerField(null=False, blank=False)
    ITEM55B_EXCUSED_ABSENCES = models.IntegerField(null=False, blank=False)
    ITEM55C_HOLIDAYS = models.IntegerField(null=False, blank=False)
    ITEM56A_HOURS_OF_PARTICIPATION = models.IntegerField(null=False, blank=False)
    ITEM56B_EXCUSED_ABSENCES = models.IntegerField(null=False, blank=False)
    ITEM56C_HOLIDAYS = models.IntegerField(null=False, blank=False)
    ITEM57A_HOURS_OF_PARTICIPATION = models.IntegerField(null=False, blank=False)
    ITEM57B_EXCUSED_ABSENCES = models.IntegerField(null=False, blank=False)
    ITEM57C_HOLIDAYS = models.IntegerField(null=False, blank=False)
    ITEM58A_HOURS_OF_PARTICIPATION = models.IntegerField(null=False, blank=False)
    ITEM58B_EXCUSED_ABSENCES = models.IntegerField(null=False, blank=False)
    ITEM58C_HOLIDAYS = models.IntegerField(null=False, blank=False)
    ITEM59A_HOURS_OF_PARTICIPATION = models.IntegerField(null=False, blank=False)
    ITEM59B_EXCUSED_ABSENCES = models.IntegerField(null=False, blank=False)
    ITEM59C_HOLIDAYS = models.IntegerField(null=False, blank=False)
    ITEM60A_HOURS_OF_PARTICIPATION = models.IntegerField(null=False, blank=False)
    ITEM60B_EXCUSED_ABSENCES = models.IntegerField(null=False, blank=False)
    ITEM60C_HOLIDAYS = models.IntegerField(null=False, blank=False)
    ITEM61A_HOURS_OF_PARTICIPATION = models.IntegerField(null=False, blank=False)
    ITEM61B_EXCUSED_ABSENCES = models.IntegerField(null=False, blank=False)
    ITEM61C_HOLIDAYS = models.IntegerField(null=False, blank=False)
    OTHER_WORK_ACTIVITIES = models.IntegerField(null=False, blank=False)
    NUMBER_OF_DEEMED_CORE_HOURS_FOR_OVERALL_RATE = models.IntegerField(null=False, blank=False)
    NUMBER_OF_DEEMED_CORE_HOURS_FOR_TWO_PARENT_RATE = models.IntegerField(null=False, blank=False)
    AMOUNT_OF_EARNED_INCOME = models.IntegerField(null=False, blank=False)
    ITEM66A_EARNED_INCOME_TAX_CREDIT = models.IntegerField(null=False, blank=False)
    ITEM66B_SOCIAL_SECURITY = models.IntegerField(null=False, blank=False)
    ITEM66C_SSI = models.IntegerField(null=False, blank=False)
    ITEM66D_WORKERS_COMPENSATION = models.IntegerField(null=False, blank=False)
    ITEM66E_OTHER_UNEARNED_INCOME = models.IntegerField(null=False, blank=False)
...
class TANF_T3(models.Model):
    ...
    ITEM70D_BLACK_OR_AFRICAN_AMERICAN = models.IntegerField(null=False, blank=False)
    ITEM70E_NATIVE_HAWAIIAN_OR_OTHER_PACIFIC_ISLANDER = models.IntegerField(null=False, blank=False)
    ITEM70F_WHITE = models.IntegerField(null=False, blank=False)
    GENDER = models.IntegerField(null=False, blank=False)
    ITEM72A_RECEIVES_BENEFITS_BASED_ON_FEDERAL_DISABILITY_STATUS_UNDER_NON = models.IntegerField(null=False, blank=False)
    ITEM72B_RECEIVES_SSI_UNDER_TITLE_XVI_SSI = models.IntegerField(null=False, blank=False)
    RELATIONSHIP_TO_HEAD_OF_HOUSEHOLD = models.IntegerField(null=False, blank=False)
    PARENT_WITH_MINOR_CHILD = models.IntegerField(null=False, blank=False)
    EDUCATION_LEVEL = models.IntegerField(null=False, blank=False)
    CITIZENSHIP_ALIENAGE = models.IntegerField(null=False, blank=False)
    ITEM77A_SSI = models.IntegerField(null=False, blank=False)
    ITEM77B_OTHER_UNEARNED_INCOME = models.IntegerField(null=False, blank=False)
