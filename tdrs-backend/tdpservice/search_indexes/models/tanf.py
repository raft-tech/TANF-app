...
class TANF_T2(models.Model):
    ...
    ITEM36C_RECEIVES_AID_TOTALLY_DISABLED_UNDER_TITLE_XIV_APDT = models.IntegerField(null=False, blank=False)
    ITEM36D_RECEIVES_AID_TO_THE_AGED = models.IntegerField(null=False, blank=False)
    ITEM36E_RECEIVES_SUPPLEMENTAL_SECURITY_INCOME_TITLE_XVI_SSI = models.IntegerField(null=False, blank=False)
...
class TANF_T3(models.Model):
    ...
    GENDER = models.IntegerField(null=False, blank=False)
    ITEM72A_RECEIVES_BENEFITS_UNDER_NON_SSA_PROGRAMS = models.IntegerField(null=False, blank=False)
