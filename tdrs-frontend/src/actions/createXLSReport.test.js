...
it('should create an action to create an XLS report', () => {
    ...
    const expectedReturn = Error('TypeError: URL.createObjectURL is not a function')
...
it('should create an action to create an XLS report and throwError', () => {
    ...
    const expectedReturn = Error('InvalidCharacterError: The string to be decoded contains invalid characters.')
    expect(getParseErrors(data_json)).toEqual(expectedReturn)
})