...
If you do not find your bug in the [raft-tech/TANF-app issues list](https://github.com/raft-tech/TANF-app/issues), file a bug report there. When reporting the bug, please follow these guidelines:

- **Please use the [Bug Report](https://github.com/raft-tech/TANF-app/issues/new?template=bug-template.md) issue template** This is populated with information and questions that will help TANF Data Portal (TDP) developers resolve the issue
...
If you don't have specific language or code to submit but would like to suggest a change, request a feature, or have something addressed, you can [open an issue in raft-tech/TANF-app](https://github.com/raft-tech/TANF-app/issues/new/choose).
...
Start your work from the `develop` branch of `raft-tech/TANF-app`. When opening a pull request, set **base repository** to `raft-tech/TANF-app` and **base branch** to `develop`. Check these fields before submitting, especially if GitHub selects the upstream `HHS/TANF-app` repository.

Please refer to readmes in the [project repo's root](https://github.com/raft-tech/TANF-app/blob/develop/README.md), [how we work](https://github.com/raft-tech/TANF-app/blob/develop/docs/How-We-Work/README.md), and [technical documentation](https://github.com/raft-tech/TANF-app/blob/develop/docs/Technical-Documentation/README.md) folders for detailed information on contributing to the project. Please see [our-workflow.md](https://github.com/raft-tech/TANF-app/blob/develop/docs/How-We-Work/our-workflow.md) for details on current PR processes.
